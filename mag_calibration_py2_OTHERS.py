...
#     return b
#
# def calibBFields2(dir, calibInfo, position_vectors=None):
...
#                 # ADL 20190501
#                 # if position vectors for each coil position have been provided, this bit runs
#                 # code below assumes that positions are provided as (x,y,z) triplets
#         else:
...
#     = 8, dir = ['r', 't', 'z'], coil = 1, pretrigger = 100, probeLocs = None):
